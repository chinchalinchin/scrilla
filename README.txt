Register for an API key at www.alphavantage.co. Create a .env file in the root directory and place your Alpha Vantage API key within it in an environment variable called AV_QUERY_URL
