...
- [Docker](https://www.docker.com/products/docker-desktop) (<span font-size:0.5em>Not required, but recommended for deploying application as a microservice.</span>)<br>
