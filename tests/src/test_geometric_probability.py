...
from .. import settings, mock

@pytest.mark.parametrize("S0,ST,vol,ret,expiry,d1", mock.bs_d1_cases)
...
@pytest.mark.parametrize("S0,ST,vol,ret,expiry,d2", mock.bs_d2_cases)
...
@pytest.mark.parametrize("S0,ST,vol,ret,expiry,prob", mock.bs_prob_d1_cases)
...
@pytest.mark.parametrize("S0,ST,vol,ret,expiry,prob", mock.bs_prob_d2_cases)
