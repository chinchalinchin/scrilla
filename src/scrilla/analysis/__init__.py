...
This module is a toolset for financial and statistical analysis. The top level functions provide general functionality, like universal statistical estimators, financial ratios and calculation techniques. Every calculation that occurs in this module assumes two things:
    ...
    2. A pricing model.
        This determines the type of probability distribution used to model the underlying price processes. Currently, only geometric brownian motion is supported (with future plans for a mean reversion model), or in other words, the price distribution is lognormal. 
...
.. notes::
    ...
    * How to model the prior volatility distribution is a more subtle questions I will need to think about.
"""