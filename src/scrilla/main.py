...
def do_program() -> None:
    ...
    if args['function_arg'] in formatter.FUNC_DICT["help"]['values']:
        def cli_help():
            outputter.help_msg()
        selected_function, required_length = cli_help, 0

    ### FUNCTION: Clear Cache
    elif args['function_arg'] in formatter.FUNC_DICT["clear_cache"]['values']:
        def cli_clear_cache():
    ...
    elif args['function_arg'] in formatter.FUNC_DICT["clear_static"]['values']:
    ...
    elif args['function_arg'] in formatter.FUNC_DICT["clear_common"]['values']:
    ...
    elif args['function_arg'] in formatter.FUNC_DICT['list_watchlist']['values']:
        def cli_watchlist():
    ...
    elif args['function_arg'] in formatter.FUNC_DICT["purge"]['values']:
        def cli_purge():
    ...
    elif args['function_arg'] in formatter.FUNC_DICT["version"]['values']:
        def cli_version():
    ...
    elif args['function_arg'] in formatter.FUNC_DICT['yield_curve']['values']:
        def cli_yield_curve():
            yield_curve = {}
    ...
    elif args['function_arg'] in formatter.FUNC_DICT['asset_type']['values']:
        def cli_asset_type():
    ...
    elif args['function_arg'] in formatter.FUNC_DICT['var']['values']:
        def cli_var():
            all_vars = {}
    ...
    elif args['function_arg'] in formatter.FUNC_DICT['cvar']['values']:
        def cli_cvar():
            all_cvars = {}
            for arg in args['tickers']:
                prices = services.get_daily_price_history(ticker=arg, 
    ...
    elif args['function_arg'] in formatter.FUNC_DICT['capm_equity_cost']['values']:
    ...
    elif args['function_arg'] in formatter.FUNC_DICT['capm_beta']['values']:
        def cli_capm_beta():
            all_betas = {}
            for arg in args['tickers']:
    ...
    elif args['function_arg'] in formatter.FUNC_DICT["close"]['values']:
        def cli_close():
            all_prices = {}
            for arg in args['tickers']:
    ...
    elif args['function_arg'] in formatter.FUNC_DICT["correlation"]['values']:
        def cli_correlation():
    ...
    elif args['function_arg'] in formatter.FUNC_DICT['correlation_time_series']['values']:
    ...
    elif args['function_arg'] in formatter.FUNC_DICT["discount_dividend"]['values']:
    ...
    elif args['function_arg'] in formatter.FUNC_DICT['dividends']['values']:
        def cli_dividends():
            all_dividends = {}
            for arg in args['tickers']:
                dividends = services.get_dividend_history(arg)
    ...
    elif args['function_arg'] in formatter.FUNC_DICT['efficient_frontier']['values']:
    ...
    elif args['function_arg'] in formatter.FUNC_DICT['maximize_return']['values']:
    ...
    elif args['function_arg'] in formatter.FUNC_DICT['moving_averages']['values']:
    ...
    elif args['function_arg'] in formatter.FUNC_DICT['optimize_portfolio']['values']:
    ...
    elif args['function_arg'] in formatter.FUNC_DICT['optimize_portfolio_conditional_var']['values']:
    ...
    elif args['function_arg'] in formatter.FUNC_DICT['plot_correlation']['values']:
    ...
    elif args['function_arg'] in formatter.FUNC_DICT['plot_dividends']['values']:
    ...
    elif args['function_arg'] in formatter.FUNC_DICT['plot_frontier']['values']:
    ...
    elif args['function_arg'] in formatter.FUNC_DICT['plot_moving_averages']['values']:
    ...
    elif args['function_arg'] in formatter.FUNC_DICT['plot_returns']['values']:
    ...
    elif args['function_arg'] in formatter.FUNC_DICT['plot_risk_profile']['values']:
    ...
    elif args['function_arg'] in formatter.FUNC_DICT['plot_yield_curve']['values']:
    ...
    elif args['function_arg'] in formatter.FUNC_DICT['price_history']['values']:
    ...
    elif args['function_arg'] in formatter.FUNC_DICT['interest_history']['values']:
    ...
    elif args['function_arg'] in formatter.FUNC_DICT['risk_free_rate']['values']:
    ...
    elif args['function_arg'] in formatter.FUNC_DICT["risk_profile"]['values']:
        def cli_risk_return():
            profiles = {}
            for arg in args['tickers']:
                profiles[arg] = statistics.calculate_risk_return(ticker=arg, 
    ...
    elif args['function_arg'] in formatter.FUNC_DICT["screener"]['values']:
        def cli_screener():
    ...
    elif args['function_arg'] in formatter.FUNC_DICT["sharpe_ratio"]['values']:
   ...
   ### FUNCTION: Store Key
    elif args['function_arg'] in formatter.FUNC_DICT['store']['values']:
        def cli_store():
    ...
    elif args['function_arg'] in formatter.FUNC_DICT["statistic"]['values']:
        def cli_statistic():
            all_stats = {}
    ...
    elif args['function_arg'] in formatter.FUNC_DICT['statistic_history']['values']:
    ...
    elif args['function_arg'] in formatter.FUNC_DICT["watchlist"]['values']:
        def cli_watchlist():
